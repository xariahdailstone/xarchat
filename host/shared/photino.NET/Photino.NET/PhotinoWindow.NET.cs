...
public partial class PhotinoWindow
{
    ...
    public void Restore()
    {
        Photino_Restore(_nativeInstance);
    }
    ...
    public void ShowDevTools()
    {
        Log($".ShowDevTools()");
        if (_nativeInstance == IntPtr.Zero)
            throw new ApplicationException("ShowDevTools cannot be called until after the Photino window is initialized.");
        Invoke(() => Photino_ShowDevTools(_nativeInstance));
    }
