...
{
	GtkWidget *dialog = gtk_message_dialog_new(
		nullptr, GTK_DIALOG_DESTROY_WITH_PARENT, GTK_MESSAGE_ERROR, GTK_BUTTONS_CLOSE, "Setting DevTools enable state");
	gtk_dialog_run(GTK_DIALOG(dialog));
	gtk_widget_destroy(dialog);
...
{
	// GtkWidget *dialog = gtk_message_dialog_new(
	// 	nullptr, GTK_DIALOG_DESTROY_WITH_PARENT, GTK_MESSAGE_ERROR, GTK_BUTTONS_CLOSE, "Showing DevTools");
	// gtk_dialog_run(GTK_DIALOG(dialog));
	//gtk_widget_destroy(dialog);
