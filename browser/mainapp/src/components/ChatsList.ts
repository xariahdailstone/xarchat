...
// @componentElement("x-channellistitem")
// export class ChannelListItem extends ComponentBase<ChatChannelViewModel | PMConvoChannelViewModel> {
//     constructor(
//         private readonly collectionView: SortedChannelCollectionView) {

//         super();

//         this.elMain.innerHTML = `
//             <div id="elUnseenIndicator" class="sectionitems-item-unseen-container">
//                 \u{2B24}
//             </div>
//             <div class="sectionitems-item-icon-container">
//                 <x-iconimage id="elIcon" class="sectionitems-item-icon" logid="channellistitem"></x-iconimage>
//                 <div id="elStatusDot" class="sectionitems-item-icondot"></div>
//             </div>
//             <div id="elTitleIcon" class="sectionitems-item-titleicon"></div>
//             <div id="elTitle" class="sectionitems-item-name">(uninitialized)</div>
//             <div class="pin-icon-container"></div>
//             <div class="close-icon-container"></div>
//         `;

//         const elMain = this.$("elMain") as HTMLImageElement;
//         const elUnseenIndicator = this.$("elUnseenIndicator") as HTMLDivElement;
//         const elStatusDot = this.$("elStatusDot") as HTMLDivElement;
//         const elIcon = this.$("elIcon") as IconImage;
//         const elTitleIcon = this.$("elTitleIcon") as HTMLDivElement;
...
//             // if (v instanceof PMConvoChannelViewModel) {
//             //     elStatusDotInner.characterSet = v.parent.characterSet;
//             // }
//             // else {
//             //     elStatusDotInner.characterSet = null;
//             // }
//         });
...
//             const characterSet = this.viewModel?.activeLoginViewModel.characterSet;
//             const charName = v as (CharacterName | null);
//             wcm.assign({ charName, characterSet }, () => {
//                 if (charName && characterSet) {
//                     const csl = addCharacterGenderListenerLightweight(characterSet, charName, elTitle);
//                     return csl;
//                 }
//             });
//             //elStatusDotInner.character = v ? v : null;
//         });

//         this.watch("unseenMessageCount", (v) => {
//             elUnseenIndicator.classList.toggle("shown", (v != null && v > 0));
//         });
//         this.watch("hasPing", (v) => {
//             if (v) {
//                 if (!elTitleIcon.firstElementChild) {
//                     const iconEl = new IconImage();
//                     iconEl.classList.add("sectionitems-item-titleicon-image");
//                     iconEl.src = "assets/ui/channel-ping.svg";
//                     elTitleIcon.appendChild(iconEl);
...
//             else {
//                 elTitleIcon.classList.remove("visible");
//                 while (elTitleIcon.firstElementChild) {
//                     elTitleIcon.firstElementChild.remove();
//                 }
//             }
//         });
//         this.watch("title", (v) => {
...
//             }
//         });
//         this.watch("parent.selectedChannel", (sc) => {
//             elMain.classList.toggle("selected", sc == this.viewModel);
//         });
...
//                     pinIco.setAttribute("src", "assets/ui/pin-icon.svg");
//                     btn.appendChild(pinIco);
//                     elMain.querySelector(".pin-icon-container")?.appendChild(btn);
//                 }
//             }
//             else {
//                 this.$("elPin")?.remove();
//             }
//         });
//         this.watch("canClose", (v) => {
//             if (v) {
//                 if (!this.$("elClose")) {
//                     const btn = document.createElement("button");
//                     btn.setAttribute("id", "elClose");
//                     btn.classList.add("close-icon");
//                     btn.addEventListener("click", (e) => {
//                         suppressThisClickAsSelection();
//                         const vm = this.viewModel;
...
//                     closeIco.setAttribute("src", "assets/ui/close-icon.svg");
//                     btn.appendChild(closeIco);
//                     elMain.querySelector(".close-icon-container")?.appendChild(btn);
//                 }
//             }
//             else {
//                 this.$("elClose")?.remove();
