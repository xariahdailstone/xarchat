...
export class ReportViewModel extends DialogViewModel<boolean> {
    ...
    async submitAsyncInternal(): Promise<string | null> {
        ...
        try {
            ...
            log = [...log, `****** Logs generated by the XarChat chat client, version ${XarChatUtils.getFullClientVersionString()}.`];
            ...
            await this.parent.alertAsync("Your report has been submitted, the moderators have been alerted.", "Report Submitted");
            return null;
        }
        catch (e) {
